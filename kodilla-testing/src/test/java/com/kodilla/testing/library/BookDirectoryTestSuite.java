...
public class BookDirectoryTestSuite {
    ...
    public void testListBooksInHandsOfNone(){
        ...
        LibraryUser user = new LibraryUser("Bilbo", "Baggins", "01092230303");
        when(libraryDatabaseMock.listBooksInHandsOf(user))
                .thenReturn(booksBorrowed);

        //When
        List<Book> listOfBooks0 = bookLibrary.listBooksInHandsOf(user);
    ...
    public void testListBooksInHandsOfOne(){
        ...
        //When
        List<Book> listOfBooks1 = bookLibrary.listBooksInHandsOf(user);
    ...
    public void testListBooksInHandsOfFive(){
        ...
        Book book3 = new Book("Secret life of programmers", "Steve Wolkowitz", 2016);
        Book book4 = new Book("Secrets of Java", "Ian Tenewitch", 2010);
        Book book5 = new Book("Secrets in the Jungle", "Ian Mckenna", 2015);
        ...
        //When
        List<Book> listOfBooks5 = bookLibrary.listBooksInHandsOf(user);
